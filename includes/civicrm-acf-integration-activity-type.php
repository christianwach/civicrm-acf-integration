...
/**
 * CiviCRM ACF Integration CiviCRM Activity Type Class.
 *
 * A class that encapsulates CiviCRM Activity Type functionality.
 *
 * @since 0.7.3
 */
class CiviCRM_ACF_Integration_CiviCRM_Activity_Type {
	...
	public function id_get_for_post_type( $post_type_name ) {
		...
		$mappings = $this->plugin->mapping->mappings_for_activity_types_get();
