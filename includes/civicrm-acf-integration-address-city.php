...
/**
 * CiviCRM ACF Integration CiviCRM City Class.
 *
 * A class that encapsulates CiviCRM City functionality.
 *
 * @since 0.8.3
 */
class CiviCRM_ACF_Integration_CiviCRM_Address_City extends CiviCRM_ACF_Integration_CiviCRM_Base {
	...
	public function address_process( $address, $args ) {
		 ...
		 * @param array $args The array of CiviCRM params.
		 */
		do_action( 'civicrm_acf_integration_address_city_update', $contact, $address, $args );
