...
<div class="cai_wrapper <?php echo $prefix; ?>">
	...
	<p><?php _e( 'Select which Post Types you want to sync to their corresponding CiviCRM Contact Types.', 'civicrm-acf-integration' ); ?></p>
	...
	<?php else : ?>
		...
		<p><?php _e( 'No synced Post Types found.', 'civicrm-acf-integration' ); ?></p>
