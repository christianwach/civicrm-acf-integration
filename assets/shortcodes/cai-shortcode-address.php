<?php
/**
 * CiviCRM ACF Integration Address Shortcode Class.
 *
 ...
 * @since 0.8.2
 */
class CiviCRM_ACF_Integration_Shortcode_Address {
	...
	public function shortcode_render( $attr, $content = '', $tag = '' ) {
		...
		if ( is_feed() ) {
			return '<p>' . __( 'Visit the website to see the Address.', 'civicrm-acf-integration' ) . '</p>';
		}
	...
	public function shortcake() {
		...
		$settings = [
			...
			// Window title.
			'label' => esc_html__( 'CiviCRM Address', 'civicrm-acf-integration' ),
	...
	public function shortcake_styles( $mce_css ) {
		...
		$mce_css .= ', ' . CIVICRM_ACF_INTEGRATION_PATH . 'assets/css/cai-shortcode-address.css';
