<?php
/**
 * CiviCRM ACF Integration State Shortcode Class.
 *
 * Provides a Shortcode for rendering CiviCRM State records.
 *
 ...
 *
 * A class that encapsulates a Shortcode for rendering CiviCRM State records.
 *
 * @since 0.8.2
 */
class CiviCRM_ACF_Integration_Shortcode_State {
	 ...
	 * @since 0.8.2
	 * @access public
	 * @var object $addresses The State object.
	 */
	public $addresses;
	...
	public function shortcode_render( $attr, $content = '', $tag = '' ) {
		...
		if ( is_feed() ) {
			return '<p>' . __( 'Visit the website to see the State.', 'civicrm-acf-integration' ) . '</p>';
		}
	...
	public function shortcake() {
		...
		$settings = [
			...
			// Window title.
			'label' => esc_html__( 'CiviCRM State', 'civicrm-acf-integration' ),
	...
	public function shortcake_styles( $mce_css ) {
		...
		$mce_css .= ', ' . CIVICRM_ACF_INTEGRATION_PATH . 'assets/css/cai-shortcode-state.css';
