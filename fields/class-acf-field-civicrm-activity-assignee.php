<?php
/**
 * CiviCRM ACF Integration Custom ACF Field Type - CiviCRM Activity Assignee Reference Field.
 *
...
/**
 * ACF "CiviCRM Activity Assignee" Class.
 *
 * A class that encapsulates a "CiviCRM Activity Assignee" Custom ACF Field in ACF 5+.
 *
 * @since 0.7.3
 */
class CiviCRM_ACF_Integration_Custom_CiviCRM_Activity_Assignee extends acf_field {
	...
	public function __construct( $parent ) {
		...
		// Define label.
		$this->label = __( 'CiviCRM Activity Assignee', 'civicrm-acf-integration' );
	...
	public function input_admin_enqueue_scripts() {
		...
		wp_enqueue_script(
			'acf-input-' . $this->name,
			plugins_url( 'assets/js/civicrm-activity-assignee-field.js', CIVICRM_ACF_INTEGRATION_FILE ),
			[ 'acf-input' ],
