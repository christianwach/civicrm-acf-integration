<?php
/**
 * CiviCRM ACF Integration Custom ACF Field Type - CiviCRM Activity Creator Reference Field.
 *
 ...
 * @since 0.7.3
 */
class CiviCRM_ACF_Integration_Custom_CiviCRM_Activity_Creator extends acf_field {
	...
	public function __construct( $parent ) {
		...
		// Define label.
		$this->label = __( 'CiviCRM Activity Creator', 'civicrm-acf-integration' );
	...
	public function input_admin_enqueue_scripts() {
		...
		wp_enqueue_script(
			'acf-input-' . $this->name,
			plugins_url( 'assets/js/civicrm-activity-creator-field.js', CIVICRM_ACF_INTEGRATION_FILE ),
			[ 'acf-input' ],
