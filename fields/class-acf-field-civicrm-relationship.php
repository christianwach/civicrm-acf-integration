 ...
 * @since 0.4.2
 */
class CiviCRM_ACF_Integration_Custom_CiviCRM_Relationship extends acf_field {
	...
	public function input_admin_enqueue_scripts() {
		...
		wp_enqueue_script(
			'acf-input-' . $this->name,
			plugins_url( 'assets/js/civicrm-relationship-field.js', CIVICRM_ACF_INTEGRATION_FILE ),
			[ 'acf-input' ],
